...
## Project Structure
    ...
    ├── testapiautoconnecto_68330  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_68330`
...
2. Clone this repo and `cd testapiautoconnecto_68330`
